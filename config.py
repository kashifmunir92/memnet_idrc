...
class Config(object):
    def __init__(self, classnum=11, splitting=2):
        ...
        # elmo
        self.need_elmo = True
        self.elmo_options = "/home/kashif/IDRR_mem-master/Projects/ELMo/elmo_2x4096_512_2048cnn_2xhighway_options.json"
        self.elmo_weights = "/home/kashif/IDRR_mem-master/Projects/ELMo/elmo_2x4096_512_2048cnn_2xhighway_weights.hdf5"
        self.elmo_dim = 300

        ###############################################################################
        # bert
        self.need_bert = False
        self.bert_path = "/home/kashif/IDRR_mem-master/Projects/BERT/cased_L-24_H-1024_A-16/"
        self.bert_dim = 300
        ...
        ################################################################################
        # Mem
        self.need_mem_bank = True
        self.mem_biaffine = True
        self.bank_dropout = 0.2
        if self.corpus_splitting == 1:
            self.use_mem_key = False
            self.use_mem_value = True
            self.mem_alpha = 0.3
            self.mem_beta = 0.5
        elif self.corpus_splitting == 2:
            self.use_mem_key = False
            ...
            self.use_mem_key = True
            self.use_mem_value = False
            self.mem_alpha = 0.3
            self.mem_beta = 0.5
        ...
        self.seed = 666
        self.batch_size = 64
        if self.need_elmo and self.need_bert:
            self.batch_size = 32
        self.shuffle = True
